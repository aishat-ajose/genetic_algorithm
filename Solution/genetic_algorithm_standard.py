...
class GeneticAlgorithmStandard:
...
# algorithm = GeneticAlgorithmStandard(population_size=500, crossover_probability=0.7, mutation_probability=0.001, benchmark_function= Rosenbrock(), maximum_iteration=100)
